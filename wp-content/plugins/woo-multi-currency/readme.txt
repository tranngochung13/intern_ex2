...
Multi Currency for WooCommerce is a plugin for WooCommerce powered online store that allows to switch to different currencies easily and create current exchange rate converter without limit WooCommerce Currency. It accepts payment with only one currency or all currencies. Multi Currency for WooCommerce is a free plugin.

>[Try the Demo](http://new2new.com/?item=woo-multi-currency "Demo Multi Currency for WooCommerce") | [Documents](http://docs.villatheme.com/?item=woo-multi-currency "Documents") | [Pro Version](http://bit.ly/woocommerce-multi-currency "Pro Version")
...
&#9658; **Easy to use:** simply configure a few steps: configure in Setting Currency, input exchange rates automatically or manually and Drag & Drop position of Multi Currency for WooCommerce Widget.
...
&#9658; [GET PRO VERSION NOW](http://bit.ly/woocommerce-multi-currency)
